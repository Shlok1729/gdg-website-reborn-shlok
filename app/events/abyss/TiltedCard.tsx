...
export default function TiltedCard({
    ...
    return (
        <figure
            ref={ref}
            className="relative w-full h-full [perspective:800px] flex flex-col items-center justify-center cursor-pointer" // Added cursor-pointer
            style={{
            ...
            onClick={onClick} // Connected onClick
        >
            {showMobileWarning && (
